...
public class AnnotationConfigApplicationContextBuilder implements SpringContextBuilder<AnnotationConfigApplicationContext> {
     ...
     * @return this Builder
     */
    public AnnotationConfigApplicationContextBuilder config(final Class<?>... configClasses) {
     ...
     * @return this Builder
     */
    private AnnotationConfigApplicationContextBuilder config(final Collection<Class<?>> configClasses) {
     ...
     * @return this Builder
     */
    public AnnotationConfigApplicationContextBuilder autowire(final Object... targets) {
     ...
     * @return this Builder
     */
    public AnnotationConfigApplicationContextBuilder autowire(final Collection<Object> targets) {
        this.autowireTargets.addAll(targets);
        return this;
    }

    public AnnotationConfigApplicationContextBuilder singleton(final String name, final Object bean) {
    ...
    public SpringContext<AnnotationConfigApplicationContext> build() {
        ...
        final AnnotationConfigApplicationContextFactory applicationContextFactory =
                new AnnotationConfigApplicationContextFactory(
                        configClasses.toArray(new Class[configClasses.size()]),
                        unmodifiableMap(new HashMap<>(beans)));

        return new SpringContext<>(applicationContextFactory, unmodifiableList(new ArrayList<>(this.autowireTargets)));
    }
}
